...
//  spacing between neighboring bubbles in the unfolded periodic row
//  (unfold across xmin: bubble centered at 0; unfold across xmax:
//  next bubble centered at Lx). See README.md in this directory:
//  this is NOT two isolated bubbles -- xmax is a mirror plane, not a
//  free surface.
//
// --.. ..- .-.. .-.. --- --.. ..- .-.. .-.. --- --.. ..- .-.. .-.. ---
...
EndIf
If(!Exists(Lx))
  Lx = 60e-6;          // center-to-center bubble spacing (m) = quarter-cell width
EndIf
If(!Exists(Ly))
  Ly = 60e-6;
EndIf
