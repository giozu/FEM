...
EndIf
If(!Exists(h_cavity))
  h_cavity = 1.487070e-07;   // fine mesh size at the cavity boundary (chosen well below lc/4 = 0.5e-6; NOT a curvature-resolution criterion -- the tip is a wedge corner, not an ellipse, see README correction note)
EndIf
If(!Exists(h_plate))
